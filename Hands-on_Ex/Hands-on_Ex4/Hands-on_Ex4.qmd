...
tm_shape(condo_resale.sf) +  
  tm_dots(col = "SELLING_PRICE",
          alpha = 0.6,
          style="quantile") +
  tm_view(set.zoom.limits = c(11,14)) + tmap_options(check.and.fix = TRUE)
```
...
### 8.3 Building a hedonistic pricing model using multiple linear regression method
...
## 9. Building Hedonistic Pricing Models using GWmodel
