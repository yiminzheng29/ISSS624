...
>
> The east and west regions of the Hunan province showed a clear divide in the choropleth map above. Areas shaded in pink/red represented areas with higher GDPPC whilst areas shaded in blue/pale blue seemed to be areas/counties with lower GDPPC.
>
...
> Question: What statistical observation can you draw from the Gi map above?
>
> Similar to the fixed weights results above, the map showed a even clearer divide between the east and west counties of the Hunan province. The east side of Hunan is covered with more pink/red areas as compared to the the Gi map under fixed weights. This validates the fact that citizens residing in the east side of the Hunan province had a distincively higher GDPPC than as opposed to residents in the west regions of the Hunan province.
